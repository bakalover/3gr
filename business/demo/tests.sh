...
curl -X POST -F "path=@./testpic/avagz.jpg" -F "albumId=3" http://localhost:8080/demo/image/add
curl -X POST -F "path=@./testpic/avagz.jpg" -F "albumId=3" http://localhost:8080/demo/image/add
curl -X DELETE http://localhost:8080/demo/album/delete/3
curl -X POST -F "path=@./testpic/avagz.jpg" -F "albumId=1" http://localhost:8080/demo/image/add
curl -X POST -F "path=@./testpic/avagz.jpg" -F "albumId=2" http://localhost:8080/demo/image/add
curl -X POST -F "path=@./testpic/avagz.jpg" -F "albumId=1" http://localhost:8080/demo/image/add
curl -X POST -F "path=@./testpic/avagz.jpg" -F "albumId=2" http://localhost:8080/demo/image/add
curl -X POST -F "path=@./testpic/avagz.jpg" -F "albumId=1" http://localhost:8080/demo/image/add
curl -X POST -F "path=@./testpic/avagz.jpg" -F "albumId=2" http://localhost:8080/demo/image/add
